...
2. Problematización: Individualización de la música y géneros musicales
3. Algunos conceptos
  - Mundos y géneros musicales
4. Propuesta y casos
...
background-image: url("img/1980album.png")
background-size: cover

---
class: bottom, slideInRight, fadeOutLeft
background-image: url("img/1990album.png")
background-size: cover
...
Para entender un género, un hiper o metagénero, como la "música urbana" tendríamos que poner en relación.
...
- adapta para el concepto de mundos del arte de Becker, considerando procesos de colaboración entre diversos actores, desdde los artistas, los técnicos, las audiencias, los manager, etcétera. 
...
- Proceso de etiquetaje: genealogías.
- Ensamblados: sonidos, personas, discursos, tecnologías 
...
- **Foco de esta presentación**: ¿Qué papel juegan las interacciones entre los artistas?
- Algo poco tratado en la discusión sobre géneros musicales, especialmente con SNA.
- Uso de SNA informado por etnografía e historia de la Música urbana chilena
...
- ¿Cuáles son los factores que permiten entender la colaboración?
	...
	- clase y raza
	- popularidad
	- ocupar ciertos espacios vacios cómo intermediarios para unir ambientes distintos
...
<div class="ba bw1" style="border-color: #808080; background-color: #000000; color: #FFFFFF; padding: 10px; border-radius: 6px; margin: 0 auto; width: 80%; position: absolute; bottom: 10%; left: 50%; transform: translateX(-50%);">
  <p style="font-size: 0.85em; color: #FFFFFF; margin: 5px 0;">
    ...
    (1) Fusión de reguetón y trap. También Mambo. Relación ambigua con Rap.
  </p>
  <p style="font-size: 0.85em; color: #FFFFFF; margin: 5px 0;">
    (2) Influencia de Puerto Rico como puente cultural.
  </p>
  <p style="font-size: 0.85em; color: #FFFFFF; margin: 5px 0;">
    (3) Rap vinculado al <em>boom-bap</em> e imagen de crítica social.
  </p>
</div>
...
## Metodología: 
  - **Extracción de datos**: canciones de artistas chilenos en Spotify entre 2019 a 2024 (Difícil!)
...
<div class="ba bw1" style="border-color: #808080; background-color: #000000; color: #FFFFFF; padding: 10px; border-radius: 6px; margin: 0 auto; width: 80%; position: absolute; bottom: 5%; left: 50%; transform: translateX(-50%);">
  <p style="font-size: 1.2em; color: #FFFFFF; margin: 5px 0; text-align: center;">
    <span class="fw6" style="color: #FFFFFF;">3.1.2. Urbano (Rap, Trap, Reggaetón, Dancehall)</span>
  </p>
</div>
...
- **Red urbana**: + colaboraciones, + probabilidad de conexión entre nodos  (más densa), - diámetro  (conexiones más cercanas), - generación de grupos (modularidad), + presencia de intermediarios relevantes (centralización), + robusta al eliminar los nodos claves (robustez)
...
- Sigue siguendo relevante lo musical, pero hay tendencias: reggaeton, trap, r&b por un lado,  dancehall-rap y boom-bap por otro, asociadas a generaciones.
- Hay asociados a zonas geográficas y crews
...
- En "Música Urbana" veo: 
  - .red[individualización en la figura del artista], con .red[redes colaborativas flexibles]. 
  - Relacionado con: 
    - (1) aspectos tecnológicos (como hacer, distribuir, consumir música)
    - (2) ethos y una estética de esta música. 
    - (3) **quiebre generacional** al interior de la música urbana: distinción rap versus resto.
