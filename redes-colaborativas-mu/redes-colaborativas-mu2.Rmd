...
- **Red urbana**: + colaboraciones, + probabilidad de conexión entre nodos  (más densa), - diámetro  (conexiones más cercanas), - generación de grupos (modularidad, alta + segemnetación), + presencia de intermediarios relevantes (centralización), + robusta al eliminar los nodos claves (robustez)
