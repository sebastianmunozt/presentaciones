...
- adapta para el concepto de mundos del arte de Becker, considerando procesos de colaboración entre diversos actores, desde los artistas, los técnicos, las audiencias, los manager, etcétera. 
...
- La música **no refleja lo social**, lo produce (De Nora, Frith).  
...
- **Las palabras y las redes**: 
  ...
  - (3) Generacional, territorial comunidades
- **Temas más generales**: 
